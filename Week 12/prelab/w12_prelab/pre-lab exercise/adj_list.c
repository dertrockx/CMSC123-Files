...
/* [2]
  ...
  do not worry if your current answer is different from this.
  if it is working as intended (inserts in a sorted manner), you may use it instead.

  choose whichever implementation is easier for you to understand
*/
